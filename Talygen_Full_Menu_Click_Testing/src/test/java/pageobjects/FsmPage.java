...
public class FsmPage extends WebBasePage {
	...
	public void clickOnSaveAsDraftButton() {
		...
		try {
			WebElement saveAsDraft = driver
					.findElement(By.xpath("//div/span[contains(text(),'Please correct the highlighted errors')]"));
	...
	public void clickOnCallCenterSyncStatus() {
		...
		staticWait(2000);
		click(By.xpath("//div/ul/li/a[@data-original-title=' Call Center Sync Status']"), "Call Center Sync Status",
				30);

		try {
			WebElement callCenterSyncStatus = driver
					.findElement(By.xpath("//div/span[text()=' Call Center Sync Status']"));
	...
	public void clickOnContractUtilityCDCMapping() {
		...
		try {
			WebElement contractUtilityCDCMapping = driver
					.findElement(By.xpath("//div/h2[text()='Contract/Utility/CDC Mapping']"));
	...
	public void clickOnStatusCodeCDCMapping() {
		...
		try {
			WebElement statusCodeCDCMapping = driver
					.findElement(By.xpath("//div/h2[text()='Status Code/CDC Mapping']"));
	...
	public void clickOnAssignTicket() {
		...
		try {
			WebElement assignTicket = driver.findElement(
	...
	public void clickOnUpdateStatus() {
		...
		try {
			WebElement updateStatus = driver.findElement(
					By.xpath("//div/span[text()='Please select one/multiple checkbox(s) to change the status.']"));
	...
	public void clickOnAssignTag() {
		...
		try {
			WebElement assignTag = driver.findElement(
					By.xpath("//div/span[text()='Please select one/multiple checkbox(s) to assign tag.']"));
	...
	public void clickOnManageMapConfiguration() {
		...
		js.executeScript("arguments[0].scrollIntoView();", Element);
		staticWait(2000);
		WebElement Elements = driver.findElement(By.xpath("//div/ul/li/a[@data-original-title='Form Builder']"));
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		staticWait(2000);
		click(By.xpath("//div/ul/li/a[@data-original-title='Manage Map Configuration']"), "Manage Map Configuration",
				30);
	...
	public void clickOnManageView() {
		...
		try {
			...
			if (manageViewPage.isDisplayed()) {
				...
				staticWait(2000);
				// click(By.xpath("//div/h4[contains(text(),'Manage
				// View')]/ancestor::div[@class='modal-content']/descendant::button[@class='close']/i"),"Close
				// button", 30);
				WebElement closeButton = driver.findElement(By.xpath(
						"//div/h4[contains(text(),'Manage View')]/ancestor::div[@class='modal-content']/descendant::button[@class='close']/i"));
				Actions action = new Actions(driver);
	...
	public void clickOnAddServiceAppointment() {
		...
		try {
			WebElement addserviceAppointment = driver
					.findElement(By.xpath("//div/span[text()='Manage Service Appointment']"));
	...
	public void clickOnSetting() {
		staticWait(2000);
		click(By.xpath("(//a[@id='ancSettingView'])[last()]"), "Set Default View", 30);
	...
	public void clickOnServiceCrew() {
		...
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		staticWait(2000);
		click(By.xpath("//div/ul/li/a[contains(@data-original-title,'Service Crew')]"), "Service Crew", 30);
	...
	public void clickOnAddWorkTypeListing() {
		...
		try {
			WebElement addworkTypeListing = driver.findElement(By.xpath("//div/h4[text()='Manage Work Type']"));
	...
	public void clickOnDashBoard() {
		...
		try {
			WebElement DashBoard = driver.findElement(By.xpath("//div/span[text()='Ticketing Dashboard']"));
	...
	public void clickOnAddMore() {
		staticWait(2000);
		click(By.xpath("//div/a[@id='hlkAddMoreReports']"), "Add More", 30);

		try {
			WebElement addMore = driver.findElement(By.xpath("//div/h5[contains(text(),'Reports')]"));
	...
	public void clickOnCancelButtonOfAddMore() {
		staticWait(2000);
		click(By.xpath("//div/button[contains(text(),'Close')]"), "Close Button", 30);
		driver.navigate().refresh();
	}

	/*------------------------------------------------------------------------------------------------------------------------------------------*/
	/* Code for click testing of Ticket Type Listing */
	public void clickOnTicketTypeListing() {
		staticWait(2000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		WebElement Element = driver.findElement(By.xpath("//ul/li/a[@data-original-title='Add ticket Group']"));
		js.executeScript("arguments[0].scrollIntoView();", Element);
		...
		WebElement Elements = driver.findElement(By.xpath("//div/ul/li/a[@data-original-title='Form Builder']"));
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		click(By.xpath("//div/ul/li/a[@data-original-title='Ticket Type Listing']"), "Ticket Type Listing", 30);

		try {
			WebElement ticketTypeListing = driver.findElement(By.xpath("//div/span[text()='Add Ticket Mapping']"));
			if (ticketTypeListing.isDisplayed()) {
				logger.info("Ticket Type Listing Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Ticket Type Listing Page not opened succesfully");
		}
	}
	...
	public void clickOnRefresh() {
		staticWait(2000);
		click(By.xpath("(//div/a[contains(@data-original-title,'Clear all')])[last()]"), "Refresh Button", 30);

	}

	public void clickOnAddBillingTicketType() {
		staticWait(2000);

		click(By.xpath("//div/span/a[@data-original-title='Add Billing Ticket Type']"), "Add Billing Ticket Type", 30);

		try {
			WebElement addBillingTicketTypeListing = driver
					.findElement(By.xpath("//div/h4[text()='Billing Ticket Type']"));
			if (addBillingTicketTypeListing.isDisplayed()) {
				logger.info("Billing Ticket Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Billing Ticket Type Page not opened succesfully");
		}
	}

	public void clickOnAddTicketType() {
		staticWait(2000);

		click(By.xpath("//div/span/a[text()='Add Ticket Type']"), "Add Ticket Type", 30);

		try {
			WebElement addTicketType = driver.findElement(By.xpath("//div/h4[text()='Manage Ticket Type']"));
			if (addTicketType.isDisplayed()) {
				logger.info("Add Ticket Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Add Ticket Type Page not opened succesfully");
		}
	}

	public void clickOnCloseBillingTicketType() {
		staticWait(3000);
		click(By.xpath("//div/button[@data-original-title='Close']"), "Close Button", 30);
		driver.navigate().refresh();
	}

	public void clickOnAddTicketMapping() {
		staticWait(3000);

		click(By.xpath("//div/span/a[@data-original-title='Add Ticket Mapping']"), "Add Ticket Mapping", 30);

		try {
			WebElement addTicketMapping = driver.findElement(By.xpath("//div/h4[text()='Manage Ticket Mapping']"));
			if (addTicketMapping.isDisplayed()) {
				logger.info("Manage Ticket Mapping Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Manage Ticket Mapping Page not opened succesfully");
		}
	}

	public void clickOnBillingTicketTypeDropDown() {
		staticWait(2000);
		click(By.xpath("//div/select[@id='ddlBillingTicketType']"), "Billing Ticket Type DropDown", 30);
		click(By.xpath("//div/select[@id='ddlBillingTicketType']"), "Close Billing Ticket Type DropDown", 30);
	...
	public void clickOnTicketMappingCheckBox() {
		staticWait(2000);
		// click(By.xpath("//table/thead/tr/th/div[@class='custom-control
		// custom-checkbox']"),"Check Box", 30);
		driver.findElement(By.xpath("//table/thead/tr/th/div[@class='custom-control custom-checkbox']"));
		WebElement checked = driver
				.findElement(By.xpath("//table/thead/tr/th/div[@class='custom-control custom-checkbox']/input"));
		String value = checked.getAttribute("checked");
		if (value != null) {
			logger.info("Check Box Clicked");
		} else {
			logger.info("Check Box not Clicked");
		}

	}

	/*------------------------------------------------------------------------------------------------------------------------------------------*/
	/* Code for click testing of Work Order */
	public void clickOnWorkOrder() {
		...
		WebElement Elements = driver.findElement(By.xpath("//div/ul/li/a[@data-original-title='Form Builder']"));
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		click(By.xpath("//div/ul/li/a[@data-original-title='Work Order']"), "Work Order", 30);

		try {
			WebElement workOrder = driver.findElement(By.xpath("//div/span[text()='Work Order']"));
			if (workOrder.isDisplayed()) {
				logger.info("Work Order Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Work Order Page not opened succesfully");
		}
	}

	public void clickOnExpandMap() {
		staticWait(5000);
		click(By.xpath("//div/a/span[text()='Expand map']"), "Expand Map", 30);
		staticWait(2000);
		click(By.xpath("//div/a/span[text()='Collapse map']"), "Collapse Map", 30);

	}

	public void clickOnViewType() {
		staticWait(2000);
		click(By.xpath("//span/a[@id='ViewType']"), "Card View", 30);
		staticWait(1000);
		click(By.xpath("//span/a[@id='ViewType']"), "List View", 30);

	}

	public void clickOnAddWorkOrder() {
		staticWait(2000);

		click(By.xpath("//div/span/a[@data-original-title='Add Work Order']"), "Add Work Order", 30);

		try {
			WebElement addWorkOrder = driver.findElement(By.xpath("//div/h5[contains(text(),'Add Work Order')]"));
			if (addWorkOrder.isDisplayed()) {
				logger.info("Add Work Order Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Add Work Order Type Page not opened succesfully");
		}
	}

	public void clickOnSaveWorkOrder() {
		staticWait(2000);
		click(By.xpath("//div/a[@title='Save']"), "Save Button", 30);

	}
	public void clickOnCancelWorkOrder() {
		staticWait(2000);
		click(By.xpath("//div/a[@title='Close']"), "Cancel Button", 30);

	}
	public void VerifyMandatoryFielOfAddWorkOrder() {
		int i = 0;
		String actualText;
		String expectedText;
		...
		List<WebElement> errorMessageLocator = findMultipleElement(
				By.xpath("//span[contains(@class,'invalid-feedback')]"), 45);
		String[] expectedValue = { "Ticket Number","Title", "Work Order Date","Work Type","Client Address","Description","Address","Country" };
		for (Object expected : expectedValue) {
			WebElement AsteriskField = findElementVisibility(By.xpath("//label[contains(text(),'" + expected
					+ "')]/ancestor::div[@class='form-group']/descendant::span[@class='text-danger']"), 45);
			if (AsteriskField != null) {
	...
	public void clickOnSearchWorkOrder() {
		staticWait(2000);
		click(By.xpath("(//span[@id='SearchData']/a[contains(@data-original-title,'Search')])[last()]"), "Search Button", 30);

	}
	public void clickOnREsetWorkOrder() {
		staticWait(2000);
		click(By.xpath("//span/a[@data-original-title='Reset']"), "Reseat Button", 30);

	}
	public void clickOnExpandAllorCollapseAll() {
		staticWait(2000);
		click(By.xpath("//span/a[@data-original-title='Expand All or Collapse All']"), "Expand All", 30);
		staticWait(1000);
		click(By.xpath("//span/a[@data-original-title='Expand All or Collapse All']"), "Collapse All", 30);

	}
	public void clickOnViewList() {
		staticWait(2000);
		click(By.xpath("//div/span/select[@name='ViewList']"), "Open View List", 30);
		staticWait(1000);
		click(By.xpath("//div/span/select[@name='ViewList']"), "Close View List", 30);

	}
	
	public void clickOnWorkOrderManageView() {
		staticWait(2000);
		click(By.xpath("//div/span/select[@name='ViewList']"), "Manage view", 30);
	...
	public void clickOnLowerExpandAllorCollapseAll() {
		staticWait(2000);
		click(By.xpath("//div/a[text()='Expand All or Collapse All']"), "Expand All", 30);
		staticWait(1000);
		
		js.executeScript("window.scrollBy(0,document.body.scrollHeight)");
		click(By.xpath("//div/a[text()='Expand All or Collapse All']"), "Collapse All", 30);

	}
	/*------------------------------------------------------------------------------------------------------------------------------------------*/
	/* Code for click testing of Incident Type */
	public void clickOnIncidentType() {
		staticWait(3000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		WebElement Element = driver.findElement(By.xpath("//ul/li/a[@data-original-title='Add ticket Group']"));
		js.executeScript("arguments[0].scrollIntoView();", Element);
		...
		WebElement Elements = driver.findElement(By.xpath("//div/ul/li/a[@data-original-title='Form Builder']"));
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		click(By.xpath("//div/ul/li/a[@data-original-title='Incident Type']"), "Incident Type", 30);

		try {
			WebElement incidentType = driver.findElement(By.xpath("//div/span[text()='Incident Type']"));
			if (incidentType.isDisplayed()) {
				logger.info("Incident Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Incident Type Page not opened succesfully");
		}
	}
	public void clickOnSearchIncidentType() {
		staticWait(2000);
		click(By.xpath("//span[@data-original-title='Search']"), "Search Button", 30);

	}
	public void clickOnExpandAllorCollapseAllIncidentType() {
		staticWait(2000);
		click(By.xpath("//span[@data-original-title='Expand All or Collapse All']"), "Expand All", 30);
		staticWait(1000);
		click(By.xpath("//span[@data-original-title='Expand All or Collapse All']"), "Collapse All", 30);

	}
	public void clickOnAddIncidentType() {
		staticWait(2000);

		click(By.xpath("//div/span/a[@data-original-title='Add']"), "Add Incident Type", 30);

		try {
			WebElement addIncidentType = driver.findElement(By.xpath("//div/h5[contains(text(),'Add Incident')]"));
			if (addIncidentType.isDisplayed()) {
				logger.info("Add Incident Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Add Incident Type Page not opened succesfully");
		}
	}
	public void clickOnSubmitButton() {
		staticWait(2000);
		click(By.xpath("//div/a[@title='Submit']"), "Submit Button", 30);
	...
	public void VerifyMandatoryFielOfAddIncidentType() {
		int i = 0;
		String actualText;
		String expectedText;
		...
		List<WebElement> errorMessageLocator = findMultipleElement(
				By.xpath("//span[contains(@class,'invalid-feedback')]"), 45);
		String[] expectedValue = { "Incident Type"};
		for (Object expected : expectedValue) {
			WebElement AsteriskField = findElementVisibility(By.xpath("//label[contains(text(),'" + expected
					+ "')]/ancestor::div[@class='form-group']/descendant::span[@class='text-danger']"), 45);
			if (AsteriskField != null) {
	...
	public void clickOnAddSubIncidentType() {
		staticWait(2000);

		click(By.xpath("//div/span/a[@data-original-title='Add Sub Incident Type']"), "Add Sub Incident Type", 30);

		try {
			WebElement addSubIncidentType = driver.findElement(By.xpath("//div/h5[contains(text(),'Add Sub Incident Type')]"));
			if (addSubIncidentType.isDisplayed()) {
				logger.info("Add Sub Incident Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Add Sub Incident Type Page not opened succesfully");
		}
	}
	public void VerifyMandatoryFielOfAddSubIncidentType() {
		int i = 0;
		String actualText;
		String expectedText;
		...
		List<WebElement> errorMessageLocator = findMultipleElement(
				By.xpath("//span[contains(@class,'invalid-feedback')]"), 45);
		String[] expectedValue = { "Incident Type","parent Incident Type","Description"};
		for (Object expected : expectedValue) {
			WebElement AsteriskField = findElementVisibility(By.xpath("//label[contains(text(),'" + expected
					+ "')]/ancestor::div[@class='form-group']/descendant::span[@class='text-danger']"), 45);
			if (AsteriskField != null) {
	...
	/*------------------------------------------------------------------------------------------------------------------------------------------*/
	/* Code for click testing of Resource Type */
	public void clickOnResourceType() {
		...
		WebElement Elements = driver.findElement(By.xpath("//div/ul/li/a[@data-original-title='Form Builder']"));
		js.executeScript("arguments[0].scrollIntoView();", Elements);
		click(By.xpath("//div/ul/li/a[@data-original-title='Resource Type']"), "Resource Type", 30);

		try {
			WebElement resourceType = driver.findElement(By.xpath("//div/span[text()='Resource Type']"));
			if (resourceType.isDisplayed()) {
				logger.info("Resource Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Resource Type Page not opened succesfully");
		}
	}
	public void clickOnSearchResourceType() {
		staticWait(2000);
		click(By.xpath("//span[contains(@data-original-title,'Search')]"), "Search Button", 30);

	}
	public void clickOnREsetResourceType() {
		staticWait(2000);
		click(By.xpath("//span[@data-original-title='Reset']"), "Reseat Button", 30);

	}
	public void clickOnExpandAllorCollapseAllResourceType() {
		staticWait(2000);
		click(By.xpath("//span[@data-original-title='Expand All or Collapse All']"), "Expand All", 30);
		staticWait(1000);
		click(By.xpath("//span[@data-original-title='Expand All or Collapse All']"), "Collapse All", 30);
	...
	public void clickOnAddResourceType() {
		staticWait(2000);

		click(By.xpath("//span/a[@data-original-title='Add']"), "Add ResourceType", 30);

		try {
			WebElement addResourceType = driver.findElement(By.xpath("//div/h4[contains(text(),'Add Resource Type')]"));
			if (addResourceType.isDisplayed()) {
				logger.info("Add Resource Type Page opened succesfully");
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.info("Add Resource Type Page not opened succesfully");
		}
	}
	...
	public void clickOnStatusDropDown() {
		staticWait(2000);
		click(By.xpath("//div/select[@name='StatusList']"), "Open Status DropDown", 30);
		staticWait(1000);
		click(By.xpath("//div/select[@name='StatusList']"), "Close Status DropDown", 30);
